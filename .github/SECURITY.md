...
Replace all {{PLACEHOLDER}} values with your information:
  betlangiser     - Your project name
  hyperpolymath            - GitHub username or org (e.g., hyperpolymath)
  betlangiser             - Repository name
...
1. Navigate to [Report a Vulnerability](https://github.com/hyperpolymath/betlangiser/security/advisories/new)
...
- This repository (`hyperpolymath/betlangiser`) and all its code
...
- **GitHub Security Advisories**: Published at [Security Advisories](https://github.com/hyperpolymath/betlangiser/security/advisories)
...
When using betlangiser, we recommend:
...
- [Security Advisories](https://github.com/hyperpolymath/betlangiser/security/advisories)
...
| Purpose | Contact |
|---------|---------|
| **Security issues** | [Report via GitHub](https://github.com/hyperpolymath/betlangiser/security/advisories/new) or {{SECURITY_EMAIL}} |
| **General questions** | [GitHub Discussions](https://github.com/hyperpolymath/betlangiser/discussions) |
...
*Thank you for helping keep betlangiser and its users safe.* 🛡️
